...
const Enter: NextPage = () => {
  ...
  const onTokenValid = (tokenData: TokenForm) => {
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="text-center text-3xl font-bold">마켓 로그인</h3>
      <div className="mt-12">
        {data?.success ? (
          ...
          <>
            <div className="flex flex-col items-center">
              <h5 className="text-sm font-medium text-gray-500">로그인 방식</h5>
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative -top-3 text-center ">
              <span className="bg-white px-2 text-sm text-gray-500">기타 로그인</span>
            </div>
          </div>
