    ...
    <div className="px-4 py-10">
      ...
      <div className="mt-12">
        ...
        <div className="mt-4 text-sm text-gray-600">
          <p>
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Deleniti, illo! Minima recusandae illo itaque sed modi ipsa eos vitae ullam
            commodi delectus, et quibusdam laudantium iste. Odit libero temporibus similique.
          </p>
        </div>
      </div>
    </div>
