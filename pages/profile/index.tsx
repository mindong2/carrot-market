      ...
      <div className="px-4">
        ...
        <div className="mt-12">
          ...
          <div className="mt-4 text-sm text-gray-600">
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima sequi velit expedita aut temporibus aliquam porro quam quae numquam,
              nesciunt saepe officia impedit doloribus voluptatem mollitia illo dolore nihil ratione.
            </p>
          </div>
        </div>
      </div>
