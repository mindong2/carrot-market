...
export default function Home() {
    ...
    return (
        ...
        <div className=" flex flex-col space-y-5 bg-slate-400 py-20 px-10 min-h-screen m-auto" style={{ maxWidth: "560px", margin: "0 auto" }}>
            {/* Receipt */}
            <div className="bg-white rounded-3xl p-6 shadow-xl">
                ...
                <div className="flex justify-between items-center mt-3 pt-2 border-t-2 border-dashed">
                    <span className="font-semibold text-lg">Total</span>
                    <span className="font-semibold">$38</span>
                </div>

                <div className="w-1/2 mx-auto mt-5 py-3 bg-blue-500 text-white text-center rounded-xl font-semibold cursor-pointer">Check out!</div>
            </div>
            {/* Profile Card */}
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="relative -top-3 bg-white flex justify-between p-8 rounded-2xl">
                    <div className="flex flex-col items-center gap-y-1">
                        <span className="font-medium text-xl">Order</span>
                        <span>$123</span>
                    </div>
                    <div className="flex flex-col items-center -mt-20">
                        <img
                            ...
                            className="w-24 h-24 rounded-full bg-red-500 mg-auto"
                        />
                        <div className="flex flex-col gap-y-2 items-center">
                            <span className="font-bold text-2xl">Dongmin2</span>
                            <span>한국</span>
                        </div>
                    </div>
                    <div className="flex flex-col items-center gap-y-1">
                        <span className="font-medium text-xl">Spent</span>
                        <span>$22</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-10 shadow-xl">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-2">
                        <span className="p-2 shadow-lg rounded-md">★</span>
                ...
                <h3 className="mt-2 font-bold text-3xl mb-1">Swoon Lounge</h3>
                ...
                <div className="flex justify-between items-center mt-3">
                    ...
                    <div className="flex items-center space-x-3">
                        <button
                            ...
                            className="flex justify-center items-center w-10 bg-blue-200 aspect-square rounded-lg text-xl"
                        >
                            -
                        </button>
                        <span>{count}</span>
                ...
                <div className="flex justify-between items-center mt-3">
                    ...
                    <button className="px-10 py-3 bg-blue-500 text-white font-semibold rounded-md">Add to Cart</button>
                </div>
            </div>

            <div className="bg-white rounded-2xl p-10 shadow-xl"></div>
        </div>
    );
}
