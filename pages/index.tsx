/* 
    * tailwind css -> mobile first sm: md: lg: xl: 2xl: (min-width로 된 media query)--- 
    * 원하는 값을 줄때는 bg-[#fff] font-[24px] 과 같이 사용가능 (중요)
*/
...
export default function Home() {
    ...
    return (
        ...
        <div className=" m-auto grid xl:grid-cols-3 md:grid-cols-2 md:place-content-center min-h-screen gap-10 bg-slate-400 px-10 py-20 sm:bg-yellow-500 md:bg-teal-400 lg:bg-indigo-400 xl:bg-red-500 2xl:bg-blue-200" >
            {/* Receipt */}
          ...
          <span className="font-semibold">$19</span>
            ...
            <div className="overflow-hidden rounded-2xl bg-white shadow-xl">
                <div className="flex items-center justify-between bg-blue-500 p-8">
                    <span className="text-2xl font-semibold text-white first-letter:text-red-400">Profile</span>
                    <span>logo</span>
                </div>
            ...
            <div className="rounded-2xl bg-white p-10 shadow-xl md:cols-span-2 lg:col-span-3">
                <form>
                    {/* 
            peer -> 뒤에오는 형제들 선택자
